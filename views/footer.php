...
<footer class="wrapper">
    <div id="social-link-footer" class="row">
        ...
        <div class="col-5 col-s-5 col-xs-4">
            <a href="http://mariageetsavoirfaire.com/" target="_blank">
                <img src="images/logo-mariage-savoir-faire.gif" alt="logo Mariage et Savoir-faire"></a>
    ...
    <div id="img-footer" itemscope itemtype="http://schema.org/Photograph">
        ...
        <p>© 2017 <span itemprop="author">Fabrice Labit</span> - Tout droit réservé -
            <span itemscope itemtype="https://schema.org/Person"><span itemprop="telephone">06&nbsp;83&nbsp;25&nbsp;24&nbsp;89</span>&nbsp;-
                <a href="mailto:contact@fabricelabit.com"><span itemprop="email">contact@fabricelabit.com</span></a></span></p>
    </div>
</footer>
